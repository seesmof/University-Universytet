...
my_print(handles.listbox1, [Rem(1:length(Rem)-2) ' were removed'],0);
if isempty(find(handles.Answer==1))
    ...
    my_print(handles.listbox1, [num2str(length(find(handles.Answer==1))) ' variants left'],0);
    my_print(handles.listbox1,'------------------------------------',0);
end;
