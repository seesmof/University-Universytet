...
2. Clone the repo
   ```sh
   git clone https://github.com/seesmof/university.git
   ```
...
See the [open issues](https://github.com/seesmof/university/issues) for a full list of proposed features (and known issues).
