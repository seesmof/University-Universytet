...
[[методичка_лекції.pdf#page=9&selection=103,0,109,1|Метою штучного інтелекту є; мета штучного інтелекту]]
[[методичка_лекції.pdf#page=10&selection=589,0,597,9|Знання про предметну область включають; властивості предметної області або властивості проблемної області]]
[[методичка_лекції.pdf#page=11&selection=66,0,77,15|Середовище, яке повністю або частково спостерігається; спостережність предметного середовища; спостережність предметної області]]