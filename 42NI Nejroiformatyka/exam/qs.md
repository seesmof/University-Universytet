...
1. Бiологiчнi нейрони. Математичні моделi нейроелементiв.
   Біологічний нейрон це тіло нейрона, дендрити (входи), аксони (виходи), синапси (з'єднання)
   Математична модель -- $y=\psi(\phi(w,x))$
...
16. Поняття: синапс, вага (ваговий коефіцієнт), поріг, дискримiнантна (вагова) функція, функція активації, бажаний і реальний вихід нейромережі.
    Синапс -- точка з'єднання, де дендрити отримують сигнали
    Вага -- коефіцієнт ?
    Поріг -- значення, після якого нейрон збуджується
    Дискримінантна (вагова, постсинаптична) функція -- поєднує зважені вхідні сигнали, передає цей постсинаптичний потенціал до функцій активації
    Функція активації (передатна) -- видає скалярне значення, яке видається на виході нейрона
    Бажаний вихід нейромережі --
    Реальний вихід нейромережі --
