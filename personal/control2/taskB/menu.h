...
void outputMenu(vector<Letter> &, string);
void outputLetters(vector<Letter> &, string);
void searchLetters(vector<Letter> &);
void searchLetters(vector<Letter> &, string);
void letterManipulation(vector<Letter> &, vector<int> &);
void searchResults(int, vector<int> &, vector<Letter> &);
