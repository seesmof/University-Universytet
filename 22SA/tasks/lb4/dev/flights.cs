...
namespace dev
{
    public partial class flights : Form
    {
        ...
        public flights()
        {
            ...
            List<flight> flights = flightsDataManager.loadFlights();
        ...
        {
            selectedFlight = flightsDataManager.getFlight(flightsList.SelectedItem.ToString());
        ...
        {
            ticketsDataManager.AddTicket(currentUser.name, selectedFlight.name, totalPrice, selectedFlight.date, (int)rowSelect.Value, middleRadio.Checked, windowRadio.Checked, privateBox.Checked, luggageBox.Checked, mealBox.Checked);
