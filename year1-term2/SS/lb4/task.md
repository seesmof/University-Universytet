...
- [ ] надання доступу до пари файлів
- [ ] в публічному чаті тегнути чувака, надіслати повідомлення всім
...
- [ ] створити груповий чат 3 учасника
...
- [ ] в чаті виконати
  - [ ] задати тему
  - [ ] розподілити ролі між учасниками
  - [ ] визначити повідомлення при появі деякого тексту в чаті, після чого вилучити учасника, в повідомленні якого даний текст з’явився, з чату
  - [ ] виконати груповий дзвінок
...
Щоб виконати завдання, виконайте наступні кроки:

1. Активуйте Google Hangouts: Увійдіть або створіть обліковий запис Google, потім перейдіть на сторінку hangouts.google.com і натисніть "Відеодзвінок", щоб розпочати зустріч. Крім того, ви можете завантажити додаток Hangouts на свій телефон і почати відеодзвінок з нього.

2. Створіть груповий чат: Під час відеодзвінка ви можете запросити людей приєднатися, надіславши їм запрошення електронною поштою або скопіювавши і вставивши надане посилання URL-адреси. Ви також можете створити груповий чат за допомогою розширення або програми Hangouts.

3. Поділіться своїм робочим столом: Щоб поділитися своїм робочим столом з одним із користувачів, натисніть меню з трьома крапками внизу екрана під час відеодзвінка і виберіть "Поділитися екраном". Ви можете надати спільний доступ до всього робочого столу або тільки до певного вікна.

4. Створіть відеотрансляцію: Щоб створити відеотрансляцію, заплануйте подію за допомогою Календаря Google і увімкніть опцію "Додати конференцію". Це створить посилання Hangouts, яким ви можете поділитися з користувачем, до якого хочете приєднатися під час трансляції. Під час трансляції натисніть меню з трьома крапками і виберіть "Додати людей", щоб запросити користувача приєднатися.

Ось кілька додаткових порад і кроків з усунення несправностей:

- Якщо у вас виникли проблеми з демонстрацією екрана, спробуйте видалити всі розширення з браузера Chrome і додати їх назад по черзі, щоб визначити винуватця. Ви також можете спробувати очистити історію браузера і тимчасові файли або скористатися альтернативним інструментом для відеоконференцій, наприклад, ezTalks, Skype, ooVoo або Facebook Messenger. [Джерело 0] [Джерело 3]
- Якщо ви хочете використовувати Google Meet замість Hangouts, зверніть увагу, що Meet призначений для корпоративного використання і пропонує більше можливостей, таких як підписи в реальному часі і підтримку до 250 учасників. [Джерело 2].
- Якщо ви хочете використовувати Google Chat для спілкування зі своєю командою, ви можете створювати потокові розмови та ділитися документами безпосередньо в додатку. Чат також пропонує вбудовані інтеграції та ботів, які допоможуть вам зробити більше. [Джерело 2].
